...
namespace AerialResources.Controllers
{
    public class ParentsController : Controller
    {
        ...
        public ParentsController(AerialResourcesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ParentID,Name,Email,Phone")] Parent parent)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var parent = await _context.Parent.SingleOrDefaultAsync(m => m.ParentID == id);
            if (parent == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ParentID,Name,Email,Phone")] Parent parent)
        {
